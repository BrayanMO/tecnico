    ...
    <div class=" bg-white py-6 flex flex-col justify-center sm:py-12">
        <div class="relative py-3 w-11/12 max-w-xl sm:mx-auto">
            <div class="relative p-8 bg-white shadow-sm sm:rounded-xl">
                <form class="w-full" action="{{ route('tiposervicio.store') }}" method="POST">
                    @csrf
                    ...
                    <button type="submit" class="w-full bg-indigo-600 text-white p-3 rounded-md">Crear Servicio</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="container w-full md:w-4/5 xl:w-3/5  mx-auto px-2">
        ...
        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                ...
                <thead>
                    <tr>
                        ...
                        <th data-priority="2">Tipo Servicio</th>
                    ...
                    @foreach ($tiposervicios as $servicio)
                        <tr>
                            ...
                            <td class="flex justify-center">
                                {{-- href="{{ route("tiposervicio.edit", $servicio->id) }}" --}}
            ...
            <a href="{{ route('dashboard') }}"> <button
                    class="p-2 pl-5 pr-5 bg-green-800	 text-gray-100 text-lg rounded-lg focus:border-4 border-blue-300">Regresar</button></a>
        </div>
        <!--/Card-->
