<div>
    ...
    <section class="mt-1 mb-4 max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        <h2 class="text-lg text-center font-semibold text-gray-700 capitalize dark:text-white">Editar Servicio
            Tecnico</h2>
        <form method="post" action="{{ route('serviciotecnico.update', $serviciotecnico) }}" autocomplete="off">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1  gap-4 mt-4 sm:grid-cols-1">
                ...
                <div>
                    ...
                    <input  id="username" name="nombredueno" type="text"
                        ...
                        pattern="^[a-zA-Z ]*$" title="NO DEBE DE TENER NUMEROS" value="{{ old('nombredueno', $serviciotecnico->nombredueno) }}">
                    @error('nombredueno')
                        {{-- Mensaje de error --}}
                        <div
                ...
                <div>
                    ...
                    <input id="username" name="apellidodueno" type="text"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        pattern="^[a-zA-Z ]*$" title="NO DEBE DE TENER NUMEROS" value="{{ old('apellidodueno', $serviciotecnico->apellidodueno) }}">
                    @error('apellidodueno')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div>
                    ...
                    <input id="emailAddress" name="emaildueno" type="email"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        value="{{ old('emaildueno', $serviciotecnico->emaildueno) }}">
                    @error('emaildueno')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div>
                    ...
                    <input id="celular" name="celulardueno" type="tel"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        pattern="[0-9]{9}" title="DEBE TENER 9 DIGITOS EL NUMERO DE TELEFONO" value="{{ old('celulardueno', $serviciotecnico->celulardueno) }}">
                    @error('celulardueno')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div>
                    ...
                    <input autocomplete="nope" id="direccion" name="direcciondueno" type="text"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        value="{{ old('direcciondueno', $serviciotecnico->direcciondueno) }}">
                ...
                <div>
                    ...
                    <input id="visible-example" type="text" list="datalist-example" name="visibleequipo"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        value="{{ old('visibleequipo',$serviciotecnico->tipoequipo->description) }}">
                        
                    <datalist id="datalist-example">
                        @foreach ($tipoequipo as $equipo)
                            <option data-value="{{ $equipo->id }}" value="{{ $equipo->description }}">
                        @endforeach
                    </datalist>
                    <input id="example" name="idtipoequipo" value="{{ old('idtipoequipo',$serviciotecnico->idtipoequipo) }}" type="hidden"> 
                    @error('idtipoequipo')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div>
                    ...
                    <input id="marca" name="marcaequipo" type="text"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        value="{{ old('marcaequipo', $serviciotecnico->marcaequipo) }}">
                    @error('marcaequipo')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div>
                    ...
                    <input id="modelo" name="modeloequipo" type="text"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        value="{{ old('modeloequipo', $serviciotecnico->modeloequipo) }}">
                    @error('modeloequipo')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div>
                    ...
                    <input id="tiposervicio" name="visibletiposervicio" type="text" list="datalist-tiposervicio"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        value="{{ old('visibletiposervicio',$serviciotecnico->tiposervicio->description) }}">
                    ...
                    <input id="IDtiposervicio" name="idtiposervicio" value="{{ old('idtiposervicio',$serviciotecnico->idtiposervicio) }}" type="hidden">
                ...
                <div>
                    ...
                    <textarea id="fallas" name="fallas"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        cols="30" rows="10">{{ old('fallas', $serviciotecnico->fallas) }} </textarea>
                    @error('fallas')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                {{-- Solucion --}}
                <div>
                    <label class="text-gray-700 dark:text-gray-200" for="solucion">Solucion</label>
                    <textarea id="solucion" name="solucion"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        cols="30" rows="10"> {{ old('solucion', $serviciotecnico->solucion) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input id="fechaentrada" type="date" name="fechaentrada"
                        ...
                        value="{{ old('fechaentrada', $serviciotecnico->fechaentrada) }}">
                    @error('fechaentrada')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div>
                    ...
                    <input id="fechasalida" type="date" name="fechasalida"
                        class="flex w-full px-2 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        value="{{ old('fechasalida', $serviciotecnico->fechasalida) }}">
                    @error('fechasalida')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div>
                    ...
                    @if ($serviciotecnico->estado==1) 
                    <input autocomplete="nope" id="estadovisible" name="estadovisible" type="text" list="listaestado"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        value="{{ old('estadovisible','Terminado') }}" autocomplete="off">
                    @elseif ($serviciotecnico->estado==0)
                        <input autocomplete="nope" id="estadovisible" name="estadovisible" type="text" list="listaestado"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        value="{{ old('estadovisible','En proceso') }}" autocomplete="off">
                    @endif
                    <datalist id="listaestado">
                        <option data-value="0" value="En proceso">
                        <option data-value="1" value="Terminado">
                    </datalist>
                    <input id="IDestado" name="estado" value="{{ old('estado',$serviciotecnico->estado) }}"  type="hidden">
                    @error('estado')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div>
                    ...
                    <input id="precio" name="precio" type="number" min="0.00" max="10000.00" step="0.01"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        value="{{ old('precio', $serviciotecnico->precio) }}">
                    @error('precio')
                        {{-- Mensaje de error --}}
                        <div
                            class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="flex justify-end mt-3">
                <button
                    class="mr-2 px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600"
                    type="submit">Modificar</button>
                {{-- Cancelar --}}
                <a class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-red-400 rounded-md hover:bg-red-200 focus:outline-none focus:bg-gray-600"
                    href="{{ route('serviciotecnico.listar') }}">
                    Cancelar
                </a>
